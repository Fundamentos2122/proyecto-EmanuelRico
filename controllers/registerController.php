    ...
    if($_SERVER["REQUEST_METHOD"] == "GET"){
        ...
        if($_POST["_method"] == "POST"){
            ...
            try{
                ...
                $query = $connection->prepare('UPDATE usuarios SET nombre_usuario = :nombre_usuario, contrasena = :contrasena, nombre_completo = :nombre_completo, fecha_nacimiento = :fecha_nacimiento WHERE id = :id');
