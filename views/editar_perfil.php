...
<body class="container">
    ...
    <div class="container-fluid container-xl" id="body-content">
        <div class="col-12 my-4 edit-profile-container">
            ...
            <form id="form_put" action="../controllers/registerController.php" method="post" autocomplete="off">
    ...
    <script>
        ...
        function getUsuario(){
            ...
            xhttp.open("GET", "../controllers/registerController.php?id=" + id_usuario, false);
